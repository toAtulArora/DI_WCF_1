...
\maketitle
\begin{abstract}
Prior to this work, the best device independent weak coin flipping protocol had bias, $\epsilon \approx 0.336$, due to SCAKPM'11 {[}10.1103/PhysRevLett.106.220501{]}. We report a protocol with bias, $\epsilon \approx 0.3148$. Under a plausible continuity conjecture, we are able to lower the bias to $\epsilon \approx 0.29104$. Our result uses the SCAKPM'11 protocol with a minor modification and owes its improved security to two techniques which we expect should work more generally: an added self-testing step and an improved composition.
