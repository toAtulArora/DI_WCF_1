...
In this work, we build on this protocol using novel pre- and post-processing steps, which we discuss in the next subsection. 
	...
	In Protocol~\ref{alg:SCForiginalJ}, a cheating party may control what is in the boxes, both the state and also the \sout{mechanics} measurements with which the outputs are given. 
...
% \section{Introduction}
	...
	\subsection{Summary of our results\label{subsec:Proof-Technique}}
