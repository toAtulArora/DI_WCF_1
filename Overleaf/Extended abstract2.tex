...
\begin{document}
\title{\vspace{-2cm}Improving the security of device-independent weak coin flipping \\ {\large \textbf{Extended abstract}} }
%\\--Extended Abstract for QCRYPT 2021 Submission--}
...
We do this is three steps that we discuss below.  
	...
	%this said \NEW{or Alice} for some reason.
