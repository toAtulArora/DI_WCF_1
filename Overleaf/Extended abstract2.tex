...
We now briefly discuss the proof of our main theorem, above. 
Basically we modify the protocol mentioned in Fact\ref{fact} using two techniques. 
	...
	Recall that for the protocol in Fact~\ref{fact}, we have $\PA=\cos^2(\pi/8)$ and $\PB=3/4$. %\Tnote{remind the bias of the Inital protocol for easy comparison}
