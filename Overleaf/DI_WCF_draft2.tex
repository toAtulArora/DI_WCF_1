...
\section{New protocols using self-testing}
...
\Tnote{What is exactly the statement of the Lemma ?}
...
``winner gets polarity''. } \Tnote{We should call this : Winner gets advantage}
