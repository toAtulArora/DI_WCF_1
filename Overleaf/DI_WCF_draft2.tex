...
\newpage  
\subsection{NEW SECTION: JAMIE STUFF} 
...
Since the objective function is also continuous in $X$, we have that $\eta \geq \lim_{\epsilon \downarrow 0}$ \eta_{\espilon}$. 
