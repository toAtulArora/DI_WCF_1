...
Issue 1:
While I like the idea, I think it is neither long enough to be fully clear (which means it causes redundancy later), nor short enough to be a quick preview of what's to come. 
But I feel its easy to fix by by removing the explicit protocols because we anyway don't use their details; our ideas are quite general. This would let us state the protocols clearly in one place (and exactly once), avoiding redundancy without any significant loss to the introduction's quality.
